		...
		try {
			...
			case 1:
				...
				case 1:
					...
					System.out.println("");
					System.out.println(
							" Composto por pão tipo brioche com batata, molho do CBO, cebola crispy, bacon em fatias,\nalface americano, queijo sabor cheddar e carne 100% de peito de frango, temperada e empanada. ");
				...
				case 2:
					...
					System.out.println("");
					System.out.println(
							" O novo McFlurry promete toda qualidade que só o Méqui e a Kopenhagen podem oferecer!\n A sobremesa é composta por espetaculares trufas Língua de Gato DUO Kopenhagen, bebida láctea sabor baunilha e cobertura sabor chocolate. ");
				...
				case 3:
					...
					System.out.println("");
					System.out.println(
							" O novo McFlurry promete toda qualidade que só o Méqui e a Kopenhagen podem oferecer!\n A sobremesa é composta por espetaculares trufas Língua de Gato DUO Kopenhagen, bebida láctea sabor baunilha e cobertura sabor morango. ");
				...
				case 4:
					...
					System.out.println("");
					System.out.println(
							" O novo McFlurry promete toda qualidade que só o Méqui e a Kopenhagen podem oferecer!\n A sobremesa é composta por espetaculares trufas Língua de Gato DUO Kopenhagen, bebida láctea sabor baunilha e cobertura sabor caramelo. ");
			...
			case 2:
				...
				case 1:
					...
					System.out.println("");
					System.out.println(
							" Delicioso molho lácteo cremoso sabor cheddar, hambúrguer de carne 100% bovina, a nova Méquinese,\n exclusiva maionese especial com sabor de carne defumada, cebola crispy, fatias de bacon, queijo sabor cheddar, tudo isso no pão tipo brioche trazendo uma explosão de sabores a cada mordida!");
				...
				case 2:
					...
					System.out.println("");
					System.out.println(
							" Composto pelo nosso pão tipo brioche, hambúrguer de carne 100% bovina, a nova Méquinese,\n exclusiva maionese especial com sabor de carne defumada, alface, tomate, fatias de bacon e queijo sabor cheddar. ");
			...
			case 3:
				...
				case 6:
					...
					System.out.println("");
					System.out.println(
							" Um hambúrguer (100% carne bovina), molho lácteo cremoso sabor cheddar, \ncebola ao molho shoyu e pão escuro com gergelim.");
				...
				case 8:
					...
					System.out.println("");
					System.out.println(
							" Dois hambúrgueres, uma explosão de sabor. Dois deliciosos hambúrgueres de carne 100% bovina, \n queijo sabor cheddar derretido, picles, cebola picada, ketchup, mostarda e pão com gergelim.");
				...
				case 10:
					...
					System.out.println("");
					System.out.println(
							" Pão sem gergelim, hambúrguer de carne 100% bovina, alface, tomate e molho tasty \n(molho emulsionado sabor carne grelhada).");
			...
			case 4:
				...
				case 2:
					...
					System.out.println("");
					System.out.println(
							" Um hambúrguer (100% carne bovina), queijo sabor emental, molho barbecue (molho não emulsionado sabor barbecue),\n fatias de bacon, tomate, alface americana, cebola crispy, molho tasty (molho emulsionado sabor carne grelhada) e pão com gergelim.");
			...
			case 5:
				...
				case 1:
					...
					System.out.println("");
					System.out.println(
							"Composto por pão tipo brioche com batata, molho do CBO, cebola crispy, bacon em fatias, alface americano,\n queijo sabor cheddar e carne 100% de peito de frango, temperada e empanada.");
				...
				case 3:
					...
					System.out.println("");
					System.out.println(
							"Sanduiche composto por pão tipo brioche com batata, carne 100% de peito de frango, \n temperada e empanada, molho lácteo cremoso sabor cheddar e fatias de bacon.");
			...
			case 7:
				...
				case 1:
					...
					System.out.println("");
					System.out.println(
							"Um hamburguer (100% bovino), alface americana, cebola, ketchup, molho tasty, maionese, picles,\n queijo sabor cheddar, tomate e pão com gergelim.");
				...
				case 2:
					...
					System.out.println("");
					System.out.println(
							"A crocante e deliciosa cebola empanada do Méqui, agora com melt sabor cheddar e bacon crispy.\n Não dá para resistir, experimente! Produto exclusivo da loja Méqui 1000 (Avenida Paulista, 1811 –São Paulo - SP).");
				...
				case 4:
					...
					System.out.println("");
					System.out
							.println(" Sobremesa composta por mix de baunilha, cobertura de morango e torta de maçã.");
				...
				case 6:
					...
					System.out.println("");
					System.out.println(
							"Esse delicioso sanduiche é composto por um hambúrguer (100% carne bovina), queijo sabor emental, bacon, \ncebola frita empanada, maionese, ketchup e pão tipo brioche. Produto exclusivo da loja Méqui 1000 (Avenida Paulista, 1811 –São Paulo -SP.)");
			...
			case 8:
				...
				case 2:
					...
					System.out.println("");
					System.out.println(
							" A batata frita mais famosa do mundo. Deliciosas batatas selecionadas, fritas, crocantes por fora, macias por dentro,\n douradas, irresistíveis, saborosas, famosas, e todos os outros adjetivos positivos que você quiser dar.");
				...
				case 13:
					...
					System.out.println("");
					System.out.println(
							" Crocantes, leves e deliciosos. Os frangos empanados mais irresistíveis do McDonald’s agora na versão Mega,\n ideal para compartilhar. Composto por 15 unidades de Chicken McNuggets.");
				...
				case 16:
					...
					System.out.println(" Caloria: 11 kcal. ");
					System.out.println("");
					System.out.println(" Mais uma opção leve de acompanhamento: tomatinhos fresquinhos.");
			...
			case 9:
				...
				case 4:
					...
					System.out.println("");
					System.out.println(
							" A medida certa entre cobertura de morango e bebida láctea sabor baunilha que pode fazer você viver uma experiência explosiva, \n além de amendoins crocantes. Desfrute dessa combinação perfeita!");
				...
				case 5:
					...
					System.out.println("");
					System.out.println(
							" A medida certa entre cobertura sabor chocolate e bebida láctea sabor baunilha que pode fazer você viver uma experiência explosiva,\n além de amendoins crocantes. Desfrute dessa combinação perfeita!");
				...
				case 6:
					...
					System.out.println("");
					System.out.println(
							" A medida certa entre cobertura de caramelo e bebida láctea sabor baunilha que pode fazer você viver uma experiência explosiva, além de amendoins crocantes.\n Desfrute dessa combinação perfeita!");
				...
				case 7:
					...
					System.out.println("");
					System.out.println(
							" Sobremesa com Bebida láctea sabor baunilha e uma supercamada de cobertura de morango e ainda por cima com farofa de paçoca.\n O canudo completa a tentação.");
				...
				case 8:
					...
					System.out.println("");
					System.out.println(
							" Sobremesa com Bebida láctea sabor baunilha e uma supercamada de cobertura sabor chocolate e ainda por cima com farofa de paçoca.\n O canudo completa a tentação.");
				...
				case 9:
					...
					System.out.println("");
					System.out.println(
							" Sobremesa com Bebida láctea sabor baunilha e uma supercamada de cobertura de caramelo e ainda por cima com farofa de paçoca.\n O canudo completa a tentação.");
				...
				case 10:
					...
					System.out.println("");
					System.out.println(
							" Não é uma sobremesa qualquer, é um verdadeiro colosso. Uma supercasquinha de biscoito em forma de cone,\n recheada com bebida láctea sabor baunilha e uma sensacional cobertura sabor chocolate. E, além de todo esse sabor, um canudinho de biscoito supercrocante.");
				...
				case 11:
					...
					System.out.println("");
					System.out.println(
							" Não é uma sobremesa qualquer, é um verdadeiro colosso. Uma supercasquinha de biscoito em forma de cone,\n recheada com bebida láctea sabor baunilha e uma sensacional cobertura de caramelo. E, além de todo esse sabor, um canudinho de biscoito supercrocante.");
				...
				case 13:
					...
					System.out.println("");
					System.out.println(
							" Boa demais. Parece a receita lá de casa. Massa quentinha e crocante envolvendo deliciosos recheios de banana ou\n maçã com gostinho de doce caseiro.");
				...
				case 18:
					...
					System.out.println("");
					System.out.println(
							" Para sua #FomeGeladinhadeMéqui nosso delicioso McFlurry Ovomaltine, com bebida láctea sabor baunilha,\n flocos de ovomaltine e cobertura sabor chocolate.");
				...
				case 22:
					...
					System.out.println("");
					System.out.println(
							" Para sua #FomeGeladinhadeMéqui nosso delicioso McFlurry Ovomaltine, com bebida láctea sabor baunilha,\n flocos de ovomaltine e cobertura de morango.");
				...
				case 23:
					...
					System.out.println("");
					System.out.println(
							" Para sua #FomeGeladinhadeMéqui nosso delicioso McFlurry Ovomaltine, com bebida láctea sabor baunilha,\n flocos de ovomaltine e cobertura de caramelo.");
				...
				case 25:
					...
					System.out.println("");
					System.out.println(
							" O novo McFlurry promete toda qualidade que só o Méqui e a Kopenhagen podem oferecer!\n A sobremesa é composta por espetaculares trufas Língua de Gato DUO Kopenhagen, bebida láctea sabor baunilha e cobertura de morango.");
				...
				case 26:
					...
					System.out.println("");
					System.out.println(
							" O novo McFlurry promete toda qualidade que só o Méqui e a Kopenhagen podem oferecer!\n A sobremesa é composta por espetaculares trufas Língua de Gato DUO Kopenhagen, bebida láctea sabor baunilha e cobertura de caramelo.");
			...
			case 10:
				...
				case 1:
					...
					System.out.println("");
					System.out.println(
							" Refrescante e geladinho. Uma bebida assim refresca a vida. Você pode escolher entre Coca-Cola, Coca-Cola Zero,\n Fanta Guaraná e Fanta Laranja.");
				...
				case 13:
					...
					System.out.println("");
					System.out
							.println(" Deliciosos sabores à sua escolha. Néctar de fruta nos sabores uva ou laranja.");
			...
			case 11:
				...
				case 6:
					...
					System.out.println("");
					System.out.println(
							" O famoso sabor da manhã. Quem nunca sentiu esse sabor logo cedo? E os nossos grãos selecionados deixam\n esse clássico do café da manhã ainda mais especial.");
			...
			case 12:
				...
				case 4:
					...
					System.out.println("");
					System.out.println(
							" O famoso sabor da manhã. Quem nunca sentiu esse sabor logo cedo?\n E os nossos grãos selecionados deixam esse clássico do café da manhã ainda mais especial.");
			...
			case 13:
				...
				case 2:
					...
					case 1:
						...
						System.out.println("");
						System.out.println(
								" A batata frita mais famosa do mundo. Deliciosas batatas selecionadas, fritas, crocantes por fora,\n macias por dentro, douradas, irresistíveis, saborosas, famosas, e todos os outros adjetivos positivos que você quiser dar.");
			...
			case 15:
				...
				case 8:
					...
					System.out.println("");
					System.out.println(
							" O nosso folhado de queijo com tomate é único e exclusivo, o seu recheio vai te conquistar na primeira mordida!\n Bora experimentar?");
